...
//
// Project: N3968-A
// Module:  dbo.REGIONALIZED_SPOT_STATUS
// Created: 2013-Oct-23
// Author:  Tony Lew
// 
// Purpose: Regionalized the SPOT Status table
//    
//
//   Current revision:
//     Release:   2.0
//     Revision:  $Id: DINGODB.dbo.REGIONALIZED_SPOT_STATUS.table.sql 3483 2014-02-11 18:34:38Z tlew $
//    
//
*/ 
...
--DROP TABLE [dbo].[REGIONALIZED_SPOT_STATUS]
...
CREATE UNIQUE INDEX UNC_REGIONALIZED_SPOT_STATUS_RegionID_NSTATUS_iCHECKSUM_VALUE ON dbo.REGIONALIZED_SPOT_STATUS ( RegionID, NSTATUS ) INCLUDE ( CHECKSUM_VALUE )
GO

CREATE UNIQUE INDEX UNC_REGIONALIZED_SPOT_STATUS_NSTATUS_RegionID_iCHECKSUM_VALUE ON dbo.REGIONALIZED_SPOT_STATUS ( NSTATUS, RegionID ) INCLUDE ( CHECKSUM_VALUE )
GO
