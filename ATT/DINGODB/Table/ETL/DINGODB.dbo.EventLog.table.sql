...
//   Current revision:
//     Release:   2.0
//     Revision:  $Id: DINGODB.dbo.EventLog.table.sql 3497 2014-02-14 00:08:24Z tlew $
//    
//
*/ 
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'DINGODB Unique Identifier for an ETL event.' , @level0type=N'SCHEMA',@level0name=N'dbo', 
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'DINGODB database ID.' , @level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE',@level1name=N'EventLog', @level2type=N'COLUMN',@level2name=N'DBID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'DINGODB database computer name.' , @level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE',@level1name=N'EventLog', @level2type=N'COLUMN',@level2name=N'DBComputerName'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'DINGODB Event log status identifier.' , @level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE',@level1name=N'EventLog', @level2type=N'COLUMN',@level2name=N'EventLogStatusID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'DINGODB Event log event description.' , @level0type=N'SCHEMA',@level0name=N'dbo', 
