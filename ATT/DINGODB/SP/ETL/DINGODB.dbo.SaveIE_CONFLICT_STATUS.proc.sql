...
IF ISNULL(OBJECT_ID('dbo.SaveIE_CONFLICT_STATUS'), 0) > 0 
	DROP PROCEDURE dbo.SaveIE_CONFLICT_STATUS
GO
...
//   Current revision:
//     Release:   2.0
//     Revision:  $Id: DINGODB.dbo.SaveIE_CONFLICT_STATUS.proc.sql 3483 2014-02-11 18:34:38Z tlew $
//    
//	 Usage:
//
//				DECLARE		@ErrNum			INT
