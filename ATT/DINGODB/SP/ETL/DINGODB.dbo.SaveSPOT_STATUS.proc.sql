...
IF ISNULL(OBJECT_ID('dbo.SaveSPOT_STATUS'), 0) > 0 
	DROP PROCEDURE dbo.SaveSPOT_STATUS
GO
...
//   Current revision:
//     Release:   2.0
//     Revision:  $Id: DINGODB.dbo.SaveSPOT_STATUS.proc.sql 3483 2014-02-11 18:34:38Z tlew $
//    
//	 Usage:
//
//				DECLARE		@ErrNum			INT
