...
USE [MASTER]
GO
/****** OBJECT:  DATABASE [DINGODB]    SCRIPT DATE: 09/17/2013 11:44:27 ******/
CREATE DATABASE [DINGODB] ON  PRIMARY 
( NAME = N'DINGODB', FILENAME = N'E:\DATA\DINGODB.MDF' , SIZE = 145408KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'DINGODB_LOG', FILENAME = N'E:\LOGS\DINGODB.LDF' , SIZE = 353920KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
GO
ALTER DATABASE [DINGODB] SET  ENABLE_BROKER
GO
...
/****** Object:  Database [DINGODB]    Script Date: 09/17/2013 11:44:27 ******/
--CREATE DATABASE [DINGODB] ON  PRIMARY 
--( NAME = N'DINGODB', FILENAME = N'D:\SQLData\DINGODB.mdf' , SIZE = 145408KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
--FILEGROUP SDB
--( NAME = Group1,
...
----    FILEGROWTH = 5 )
-- LOG ON 
--( NAME = N'DINGODB_log', FILENAME = N'D:\SQLLog\DINGODB.ldf' , SIZE = 353920KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
--GO
--ALTER DATABASE [DINGODB] SET COMPATIBILITY_LEVEL = 100
--GO
--IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
...
--DROP PARTITION FUNCTION [SDBPartitionKeyRange]
--CREATE PARTITION FUNCTION [SDBPartitionKeyRange] (int)
--AS RANGE RIGHT FOR VALUES 
--(10,20,30,40,50,60,70,80,90)

--DROP PARTITION FUNCTION [SDBPartitionKey]
CREATE PARTITION FUNCTION [SDBPartitionKey] (int)
...
--DROP PARTITION SCHEME [SDBPartitionKeyScheme]
CREATE PARTITION SCHEME [SDBPartitionKeyScheme]
AS PARTITION [SDBPartitionKey]
ALL TO ( SDB )
